...
const Impact = () => {
    ...
    const cardClass = "bg-[#050505]/95 backdrop-blur-xl border border-white/5 rounded-[2.5rem] px-8 pt-8 pb-10 flex flex-col gap-5 relative overflow-hidden shadow-2xl transition-all duration-500 ease-out will-change-transform";
    ...
    return (
        <section className="py-32 px-6 relative overflow-hidden bg-[#050505] min-h-screen">
            ...
            <div className="w-full px-4 md:px-[6vw] relative z-10">
                ...
                <div className="grid grid-cols-1 gap-5 relative z-20 lg:grid-cols-[minmax(280px,1fr)_minmax(520px,1.4fr)_minmax(280px,1fr)] lg:grid-rows-[minmax(0,1fr)_minmax(0,1fr)] items-stretch lg:min-h-[70vh]">

                    {/* Problem Solving: left top */}
                    <BorderGlow {...glowProps} className="lg:col-start-1 lg:row-start-1">
                      <div className={`${cardClass} min-h-[240px] lg:h-full justify-between`}>
                    ...
                    <BorderGlow {...glowProps} className="lg:row-span-2 lg:col-start-2 lg:row-start-1">
                      <div className={`${cardClass} h-full`}>
                        ...
                        <div className="w-full bg-[#0a0a0a]/80 backdrop-blur-md rounded-3xl border border-white/10 p-5 md:p-6 mb-auto shadow-[0_20px_50px_rgba(0,0,0,0.7)] transform transition-transform duration-500 mt-5 relative z-10 font-mono text-sm md:text-base">
                    ...
                    <BorderGlow {...glowProps} className="lg:col-start-3 lg:row-start-1">
                      <div className={`${cardClass} min-h-[240px] lg:h-full justify-between`}>
                        ...
                        <div className="mt-auto relative z-20">
                            ...
                            <h3 className="text-2xl md:text-3xl font-boldonse font-bold text-white mb-3 tracking-wide">{impacts.realworld.title}</h3>
                    ...
                    <BorderGlow {...glowProps} className="lg:col-start-1 lg:row-start-2">
                      <div className={`${cardClass} min-h-[240px] lg:h-full justify-between`}>
                          <div className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/12 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-0" />

                        <div className="mt-auto z-20 relative">
                            {impacts.leadership.icon}
                            <h3 className="text-2xl md:text-3xl font-boldonse font-bold text-white mb-3 tracking-wide">{impacts.leadership.title}</h3>
                    ...
                    <BorderGlow {...glowProps} className="lg:col-start-3 lg:row-start-2">
                      <div className={`${cardClass} min-h-[260px] lg:h-full justify-between`}>
                          <div className="absolute inset-0 bg-gradient-to-tr from-[#D4AF37]/12 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-0" />
